#ESTE CÓDIGO É USADO PARA GERAÇÃO DE CACHE EM AMBIENTE DE DEV (LOCAL)
#OBS: PARA Q ELE FUNCIONE, A APLICAÇÃO PRECISA DE TER A ROTA DE GERAÇÃO COMPLETA, COMO NO CASO QUE ELE FOI CRIADO.
import webbrowser
import requests
